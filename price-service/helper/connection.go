...
func ConnectDB() (*mongo.Collection, *mongo.Collection, *mongo.Collection) {
	...
	priceCollection := mongoDB.Collection("price")

	return exchangeCollection, assetsCollection, priceCollection
}
